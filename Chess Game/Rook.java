...
public class Rook extends ChessPiece {
    ...
    public Rook(char symbol, String currentPosition, int player) {
        super(4, symbol, currentPosition, player);
    }
    ...
    public void move(Player player, Player opponent, int currentRound, ChessPiece[][] board) {
        ...
        if (validifyPosition(desiredCords)) {
            if (!checkForPiece(board, desiredIndices) && verifyMovement(desiredCords) && !piecesBetween(desiredCords, board)) {
                ...
                System.out.println("\u001B[1m\u001B[32mRook moved from " + previousPosition + " to " + currentPosition + "\u001B[0m");
    ...
    public boolean verifyMovement(String desiredCords) {
        if (desiredCords.charAt(0) - currentPosition.charAt(0) != 0 ^ desiredCords.charAt(1) - currentPosition.charAt(1) != 0) {
            return true;
        }
        return false;
    }
